...
import { registrarOficio, editarOficio, actualizarEstatusOficio, guardarRespuestaUAD, agregarAclaracionUAD, marcarVisto, marcarVistoAOF } from '../controllers/oficio.controller.js'
...
router.post('/oficios/:id/aof-visto',
  authMiddleware, requireAOF, csrfProtection,
  marcarVistoAOF)
